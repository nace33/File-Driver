...
struct DriveView_RowLabel : View {
...
//            Moved to DriveView.body so multiple selected items can have context menu
//                .if(delegate.actions.isNotEmpty) { content in
//                    content
//                        .contextMenu {
//                            DriveView_HeaderActionButtons(file: file.wrappedValue, style: .text)
//                        }
//                }
        }
    }
